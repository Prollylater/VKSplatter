                                        ...
                                        const QueueFamilyIndices &indices)
{
    ...
    ImageData<stbi_uc> texture = LoadImageTemplate<stbi_uc>("./ressources/textures/imgmoche.png", STBI_rgb_alpha);
...
void TextureManager::createTextureImageView(VkDevice device)
{
    ...
    if (vkCreateImageView(device, &viewInfo, nullptr, &mTextureImageView) != VK_SUCCESS)
    {
